...
/// with an actual pointer (web/desktop) — a no-op on touch.
...
class _SettingsScreenState extends State<SettingsScreen>
  ...
  // Scrollbar controller — shared with the ListView it wraps.
  ...
  void _openVerifyProfile() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const OtpVerificationScreen(email: 'maya@example.com'),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Scrollbar(
        ...
        child: ListView(
          controller: _scrollController,
          padding: const EdgeInsets.fromLTRB(20, 4, 24, 40),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text('Edit your profile & preferences',
                    style:
...
/// "danger" action rather than a filled button.
